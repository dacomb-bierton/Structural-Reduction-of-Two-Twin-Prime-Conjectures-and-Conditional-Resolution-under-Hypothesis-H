# Proof of Bierton’s Twin-Prime Conjectures under Dickson’s Conjecture
...
Neither statement is proved in ZFC alone. Each implies the classical twin-prime conjecture. What *is* proved is that both are formal consequences of standard arithmetic hypotheses (Dickson’s conjecture / Hypothesis H for linear forms, and a uniform Bateman–Horn asymptotic).
...
|-----------|------------|------------|
| **Theorem A (Propagation)** | Dickson’s conjecture | Infinitely many consecutive pairs in \(\mathcal{T}\) propagate via \(C = p+q+1\) |
...
The propagation statement is exactly Dickson’s conjecture for the single admissible 6-tuple
\[
...
3. The identification of both conjectures with standard hypotheses (Dickson / uniform Bateman–Horn).
...
```
Bierton, D. (2026). A twin-prime propagation conjecture. Zenodo. https://doi.org/10.5281/zenodo.22017371
Bierton, D. (2026). A twin-gap existence conjecture. Zenodo. https://doi.org/10.5281/zenodo.22058355
Bierton, D. (2026). Proof of Bierton’s twin-prime conjectures under Dickson’s conjecture.
```
